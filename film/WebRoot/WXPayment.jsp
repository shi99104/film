...
<html>
  ...
  <body>
	...
	<div id="main">
		...
		<div id="down">
			<div id="down_1">
				<span style="border-style: ridge;border-width: 1px;border-bottom: none;"><a href="WXPayment.jsp">微信</a></span> <span><a href="ZFBPayment.jsp">支付宝</a></span>
			</div>
			<div id="down_2">
				<img src="图片\weixin.jpg" Style="width:200px;height:200px;"></div>
			<div id="down_3">
			<form action="Paid">

...
<html>
  ...
  <body>
	...
	<div id="zhong">
	<%	String region= request.getSession().getAttribute("area").toString();%>
	<div id="c12"><h2>搜索 “<%=region%>”</h2></div>
	<% 
		try{
		Connection conn = ConnectionFactory.createConnection();
		String sql="SELECT * FROM 电影信息  WHERE region LIKE '"+"%"+region+"%"+"'"; 

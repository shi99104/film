...
<html>
  <head>
    ...
    <title>预订时间(下一天)|网上电影票预订系统</title>
	  <style type="text/css">
	...
	<div id="footer">
		...
		<table width="80%" align="center" height="60px">
			...
			<td>${laguae}</td>
				...
				<input type="hidden" name="date" value="<%=m%>月<%=d1%>日08:30">
			...
			<td  class="d2">${laguae}</td>
				...
				<input type="hidden" name="cinema" value="${cinema}">
				<input type="hidden" name="monovalent" value="${monovalent}">
				<input type="hidden" name="date" value="<%=m%>月<%=d1%>日11:30">
		...
		<table width="80%" align="center" height="60px">
			...
			<td class="d2">${laguae}</td>
				...
				<input type="hidden" name="cinema" value="${cinema}">
				<input type="hidden" name="monovalent" value="${monovalent}">
				<input type="hidden" name="date" value="<%=m%>月<%=d1%>日12:20">
		...
		<table width="80%" align="center" height="60px">
			...
			<td class="d2">${laguae}</td>
				...
				<input type="hidden" name="cinema" value="${cinema}">
				<input type="hidden" name="monovalent" value="${monovalent}">
				<input type="hidden" name="date" value="<%=m%>月<%=d1%>日16:30">

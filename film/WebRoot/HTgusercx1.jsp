  ...
  <div id="zong">
    ...
    <div id="up">
     ...
     pageCurrent=Integer.parseInt(pageNo);
		...
		String sql="SELECT * FROM 管理员信息  WHERE user LIKE '"+"%"+user+"%"+"'"; 
      ...
      <input type="submit" value="搜索" style="width:50px;">
	   ...
	   <td><a href="GuserscProcess.jsp?number=<%=number%>">删除</a></td></tr>
	        ...
	        rowCurrent++;
	         ...
	         %>
	         <tr align="center" valign="middle"><td colspan="6"><p align="center" class="p">
	        <form method="post" action="HTgusercx1.jsp">
	        第<%=pageCurrent%>页 共<%=pageCount%>页&nbsp;
	        <%if(pageCurrent>1) {%>
	        <a href="HTgusercx1.jsp?pageno1">首页</a>
	        <a href="HTgusercx1.jsp?pageno=<%=pageCurrent-1%>">上一页</a>
	        <%} %>&nbsp;
	        <%if(pageCurrent<pageCount){ %>
	        <a href="HTgusercx1.jsp?pageno=<%=pageCurrent+1%>">下一页</a>
	        <a href="HTgusercx1.jsp?pageno=<%=pageCount%>">尾页</a>

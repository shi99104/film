...
<html>
  <head>
    ...
    <style type="text/css">
		*{padding: 0px;margin: 0px;}
		...
		#e1 ul li{width:10%;margin-right:10px;display: inline-block;vertical-align: middle;margin-top: 4px;position:relative;}
  ...
  <body>
    <div id="header">
		<div class="b1" id="left1">
		<div class="e1" id="e1">
			<ul>
		<li><h4>欢迎光临本站</h4>
		</li><li><a href="UserLanding.jsp"><img src="图片/676062a938fb8ffffa2f8b9f7e938f57.png">${nc}</a>
	       <ul>
	...
	<div id="main">
	 <div id="ls"><h3 style="margin-left: 20px;">关注记录</h3></div>
	  <% 
	 ...
	 while(rs.next()){
	      ...
	      <div class="ls">
	         ...
	         <div class="delete"><a href="DeleteChronicle.jsp?number=<%=number%>">删除</a></div>
		</div>
		      <%	       
	        }
	         %>

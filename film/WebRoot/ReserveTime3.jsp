...
<html>
  <head>
    ...
    <title>预订时间(下三天)|网上电影票预订系统</title>
	  <style type="text/css">
  ...
  <body>
	...
	<div id="footer">
		<div id="time">	
			...
			<li><a href="ReserveTime2.jsp">5月31日</a></li>
			<li><a href="ReserveTime3.jsp" style="border-bottom-style:ridge;"><%=m3%>月<%=d3%>日</a></li>
			</ul>
		</div>
		<div id="class_zong" >
			...
			<tr align="center"><td><p class="p1">08:30</p><p class="p2">11:20散场</p></td>
			<td>${laguae}</td>
				<td>￥${monovalent}</td>
				<td>
				...
				<input type="hidden" name="date" value="<%=m3%>月<%=d3%>日08:30">
			...
			<td  class="d2">${laguae}</td>
				...
				<input type="hidden" name="cinema" value="${cinema}">
				<input type="hidden" name="monovalent" value="${monovalent}">
				<input type="hidden" name="date" value="<%=m3%>月<%=d3%>日11:30">
		...
		<table width="80%" align="center" height="60px">
			...
			<td class="d2">${laguae}</td>
				...
				<input type="hidden" name="cinema" value="${cinema}">
				<input type="hidden" name="monovalent" value="${monovalent}">
				<input type="hidden" name="date" value="<%=m3%>月<%=d3%>日12:20">
		...
		<table width="80%" align="center" height="60px">
			...
			<td class="d2">${laguae}</td>
				...
				<input type="hidden" name="cinema" value="${cinema}">
				<input type="hidden" name="monovalent" value="${monovalent}">
				<input type="hidden" name="date" value="<%=m3%>月<%=d3%>日16:30">

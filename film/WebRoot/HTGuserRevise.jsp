 ...
 */
  ...
  <body>
   <div id="zong">
      ...
      <form action="HTGuserRevise" method="get">
		...
		<tr><td>密码</td><td><input type="text" name="password" value="<%=password%>" maxlength="10"></td>${password}</tr>
		<tr><td>注册时间</td><td><input type="text" readonly name="time" value="<%=time%>"class="xg"></td></tr>

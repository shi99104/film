 ...
 */
  ...
  <body>
   <div id="zong">
     ...
     <form action="HTplTJprocess" method="get"> 
	<table align="center" cellspacing="20">
		<caption>电影影评添加</caption>
		<tr>
		<td>用户昵称：</td><td><input type="text" name="nickname"></td>
		</tr>
		<tr>
		<td>电影名</td><td><input type="text" name="FilmTitle"></td>
		</tr>
		<tr>
		<td>影评：</td><td><textarea rows="5" cols="50" name="discuss"></textarea></td>
		</tr>		

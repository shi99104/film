  ...
  <body>
   <div id="zong">
	...
	<div id="main">
      ...
      <div id="up">
      <%String cinema1=request.getParameter("cinema");
     ...
     pageCurrent=Integer.parseInt(pageNo);
		...
		String sql="select* FROM 影院信息 WHERE cinema LIKE '"+"%"+cinema1+"%"+"'"; 
	   ...
	   <td><a href="HTyyxxscProcess.jsp?number=<%=number%>">删除</a></td></tr>
	       <%
	         ...
	         %>
	         <tr align="center" valign="middle"><td colspan="9"><p align="center" class="p">

  ...
  <body>
	...
	<ul>	
		...
		<ul>
			<li>时间：</li>
			<li><a href="wholefilm.jsp">全部</a></li>
				<li><a href="Screen?age=2021">2021</a></li>
	...
	<%	String releasedate= request.getSession().getAttribute("age").toString();
	%>
	<div id="c12"><h2>搜索 “<%=releasedate%>”</h2></div>
	<%
		try{
		Connection conn = ConnectionFactory.createConnection();
		String sql="SELECT * FROM 电影信息  WHERE releasedate LIKE '"+"%"+releasedate+"%"+"'"; 
